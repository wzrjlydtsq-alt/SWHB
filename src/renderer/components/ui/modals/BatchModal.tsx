...
export function BatchModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      />
      <div
        className={`relative w-[90vw] h-[85vh] max-w-7xl rounded-lg shadow-2xl flex flex-col bg-[var(--bg-panel)] border border-[var(--border-color)]`}
      >
        {/* 顶部栏 */}
        <div
        ...
        >
          <div className="flex items-center gap-4">
            <h2 className={`text-lg font-bold text-[var(--text-primary)]`}>批量素材管理</h2>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-3 py-1.5 text-xs rounded transition-colors bg-[var(--bg-secondary)] text-[var(--text-secondary)] hover:bg-[var(--bg-hover)]`}
            >
            ...
            <button
              ...
              className={`p-1.5 rounded transition-colors text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-hover)]`}
            >
              <X size={18} />
            </button>
          </div>
              ...
              return (
                <div
                  ...
                  className={`relative rounded-lg overflow-hidden border-2 cursor-pointer transition-all ${
                    isSelected
                      ? 'border-[var(--primary-color)] shadow-lg shadow-[var(--primary-color)]/20'
                ...
                >
                  ...
                  >
                    {item.status === 'completed' ? (
                      hasFourImages ? (
                        ...
                        <div
                          className={`w-full h-full flex items-center justify-center text-[var(--text-muted)]`}
                        >
                          <FileImage size={24} />
                        </div>
                      )
                  ...
                  {/* 底部信息 */}
                  <div
                    className={`p-2 text-xs bg-[var(--bg-secondary)] text-[var(--text-primary)]`}
                  >
