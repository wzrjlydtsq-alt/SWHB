          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-[var(--text-primary)]">
                🎬 AI 导演 — {step === 1 ? '创意输入' : step === 2 ? '剧本预览' : '分镜图生成'}
              </h3>
              <p className="text-[10px] text-[var(--text-muted)] mt-0.5">
                {step === 1
                  ...
                  : step === 2
                    ...
                    : `${Object.values(shotImages).filter((v: any) => v.status === 'done').length} / ${scriptData?.shots?.length || 0} 张已完成`}
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-1 mr-2">
              {[1, 2, 3, 4].map((s) => (
                <div
                  ...
                  style={{
                    background:
                      s === step ? '#f59e0b' : s < step ? '#34d399' : 'var(--border-color)',
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {scriptData.scenes.map((s) => (
                          ...
                          >
                            <span className="text-[11px] font-semibold text-blue-400">{s.id}</span>
                            <span className="text-[11px] text-[var(--text-primary)] ml-1.5">
                              {s.name}
                            </span>
                          </div>
          ...
          {step === 3 && (
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                {Object.values(shotImages).every((v: any) => v.status === 'done') && (
                  <button
                    onClick={() => {
                      setStep(4)
                      ...
                      <button
                        onClick={async () => {
                          ...
                          try {
                            ...
                            if (result.success) {
                              if ((result as any).exported !== false) {
