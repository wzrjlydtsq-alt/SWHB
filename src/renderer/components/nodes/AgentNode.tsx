import { Trash2, MessageSquare, User, Bot, Zap, Layout } from '../../utils/icons.tsx'
...
export const AgentNode = ({
  ...
  const handleRunAgent = async () => {
    ...
    updateNodeSettings(node.id, {
      logs: addLog(`使用模型: ${config.modelName || config.id}`)
    })
  ...
  return (
    <div className="flex flex-col h-full pointer-events-auto">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-3 space-y-3 min-h-0">
        ...
        {/* Controls */}
        <div className="node-footer-controls flex flex-col gap-1 w-full justify-center">
          <button
