...
export function CanvasFeature({
  ...
  const { startGeneration } = useGenerationManager({
    ...
    chatApiKey: useAppStore.getState().chatApiKey,
    chatApiUrl: useAppStore.getState().chatApiUrl,
    imageApiKey: useAppStore.getState().imageApiKey,
    imageApiUrl: useAppStore.getState().imageApiUrl,
    videoApiKey: useAppStore.getState().videoApiKey,
    videoApiUrl: useAppStore.getState().videoApiUrl,
    apiConfigsMap,
